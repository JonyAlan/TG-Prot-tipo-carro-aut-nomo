...
void setup() {
  ...
  // Para Sorocaba-SP, o ângulo de declinação é 21'2W (positivo)
  // Fórmula: (deg + (min / 60,0)) / (180 / M_PI);
  float decinationAngle = ( 4.0 + ( 26.0 / 60.0 )) / ( 180 / M_PI);
}
...
//for(i = 0; i < 20 ; i++){ //Faz a leitura 50 e armazenar a somatória
  ...
  if (recebido){ 
	...
	float destLatitude[] = {-23.480395 -23.480338, -23.480282, -23.480234, -23.480183, -23.480132, -23.480082, -23.480031 };
    float destLongitude[] = {-47.425745 -47.425799, -47.425854, -47.425911, -47.425969, -47.426029, -47.426087, -47.426145 };
